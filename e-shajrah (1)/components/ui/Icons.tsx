...
export const UsersIcon = () => <svg {...iconProps} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.101a11.969 11.969 0 01-.849-3.734c0-1.298.368-2.52.998-3.557M8.624 21a9.986 9.986 0 01-3.624-1.928v-4.995c0-1.03.832-1.875 1.875-1.875h.5c.656 0 1.28.263 1.738.723l.004.004a1.875 1.875 0 01.723 1.738v.5c0 1.042-.832 1.875-1.875 1.875h-.5M15 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /></svg>;
export const UserIcon = () => <svg {...iconProps} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" /></svg>;
